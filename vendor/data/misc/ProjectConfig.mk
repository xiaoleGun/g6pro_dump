...
CUSTOM_HAL_IMGSENSOR = sc031gs_mipi_raw gc5004_mipi_raw gc5025_mipi_raw gc02m2_mipi_raw
CUSTOM_HAL_LENS = dw9714af
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = sc031gs_mipi_raw gc02m2_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9714af
CUSTOM_HAL_MSENSORLIB =akl
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = 
CUSTOM_HAL_SUB_IMGSENSOR = gc5004_mipi_raw gc5025_mipi_raw 
...
CUSTOM_KERNEL_IMGSENSOR = sc031gs_mipi_raw gc5004_mipi_raw gc5025_mipi_raw gc02m2_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = sc031gs_mipi_raw gc02m2_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc5004_mipi_raw gc5025_mipi_raw
...
CUSTOM_MODEM = mx8_80_3g_case1_o
...
#[denqin begin]aobingsheng delete 
...
#[denqin begin] add by aobingsheng turn on
...
#[denqin begin]bing 20200506
MTK_EXCHANGE_SUPPORT = no
#[denqin end]
MTK_RUNNING_BOOSTER_THROTTLE = yes
#########################denqin begin ##################################################

DENQIN_VERSION_NUM = V1.2.4
HYS_OTA_VERSION = V1.2.4
 
DENQIN_DISPLAY_UI_SUPPORT=340X800
DENQIN_M_BL02_SCANPEN_APP = no
DENQIN_BL02_ADD_SYSTEM_SPACE = yes

#翻译机去掉多余apk
DENQIN_REMOVE_SYSTEM_APP_CUSTOM=yes
DENQIN_REMOVE_BDIDU_LOCATION=yes

#关机窗口只显示power和restart，
DENQIN_M_GLOBAL_ACTIONS_STYLE=

DENQIN_DEVICE_PROVISIONED_DEFAULT_TRUE=yes
#去掉锁屏
DENQIN_LOCKSCREEN_DEFAULT_DISABLE=yes

#去掉android is starting
DENQIN_REMOVE_ANDROID_IS_STARTING=yes

#USB 默认MTP模式
DENQIN_MODIFY_USB_FUNCTION_MTP=yes

#翻译机工程模式
DENQIN_TRANSLATOR_FACTORY_TEST=yes

#翻译机老化测试
DENQIN_CUSTOM_TRANSLATOR_AGINGTEST=yes
DENQIN_TRANSLATOR_AGINGTEST_SECRET_CODE_9898=yes


#不同app开关
HYS_XM_APP=no
HYS_JXW_SH_HUATONG_SUPPORT = no
HYS_JXW_PUBLIC_SUPPORT = no

HYS_ANIMATION_SUPPORT_WELCOME = no
HYS_ANIMATION_SUPPORT_PORT = no
HYS_ANIMATION_SUPPORT_WGBIRDS = no
HYS_ANIMATION_SUPPORT_DOSMONO = no
HYS_ANIMATION_SUPPORT_SMCDB = no
HYS_ANIMATION_SUPPORT_AIQIYI = yes
HYS_ANIMATION_SUPPORT_NEWYES = no
HYS_ANIMATION_SUPPORT_DOSMONOHW = no
HYS_LANDSCAPE_MODE = yes

HYS_SHUANGHOU_DOSMONOHW_SUPPORT = no
HYS_SHUANGHOU_DOSMONOHW_DOSMONO_SUPPORT = no
HYS_SHUANGHOU_NEWYES_SUPPORT = no
HYS_SHUANGHOU_SUPPORT = yes
HYS_JIUXUEWANG_SUPPORT = no
HYS_HAOXUEZI_SUPPORT = no
HONGYAO_YYT_APP = no

### HONGYAO FEATURE BEGIN ###
#emmc_1+8 emmc_1+16 emmc_2+32
HONGYAO_MEMORY_TYPE = emmc_1+16
SHULIAN_FOTA_SUPPORT = no

HONGYAO_KEYPOWER_DOUBLERESS_INSTEAD_KEYBACK = yes

#rom_fake 
HYS_SYS_ROM_FR = yes
### HONGYAO FEATURE END ###
HONGYAO_SYSTEM_SIMPLIFY = yes
#########################denqin end ##################################################